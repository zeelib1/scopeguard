...
export const getTemplateList = (): Array<{ id: string; name: string; description: string }> => {
...
export const getTemplate = (templateId: string): ProjectTemplate | null => {
  return templates[templateId] || null;
};

export { templates };
export default { templates, getTemplateList, getTemplate };
