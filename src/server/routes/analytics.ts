...
router.get('/clients', (req: AuthRequest, res: Response): void => {
  try {
    const userId = req.user.id;
...
router.get('/trends', (req: AuthRequest, res: Response): void => {
  try {
    const userId = req.user.id;
...
router.get('/scope-health', (req: AuthRequest, res: Response): void => {
  try {
    const userId = req.user.id;
