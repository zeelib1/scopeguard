...
router.post('/projects/:projectId/portal/generate', authMiddleware, (req: AuthRequest, res: Response): void => {
  try {
...
router.get('/projects/:projectId/portal/tokens', authMiddleware, (req: AuthRequest, res: Response): void => {
  try {
    const projectId = req.params.projectId;
...
router.delete('/projects/:projectId/portal/tokens/:tokenId', authMiddleware, (req: AuthRequest, res: Response): void => {
  try {
    const projectId = req.params.projectId;
...
router.get('/portal/:token', (req: AuthRequest, res: Response): void => {
  try {
