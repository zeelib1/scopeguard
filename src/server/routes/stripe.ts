...
router.get('/plans', (req: AuthRequest, res: Response): void => {
  try {
...
router.post('/create-checkout-session', authMiddleware, async (req: AuthRequest, res: Response): void => {
  try {
...
router.post('/webhook', express.raw({ type: 'application/json' }), async (req: AuthRequest, res: Response): void => {
  try {
...
router.get('/portal', authMiddleware, async (req: AuthRequest, res: Response): void => {
  try {
    const user = req.user;
